...
export const BannerForm = ({ onSubmit }: BannerFormProps) => {
  ...
  const colors = {
    ...
    pinkneon: 'bg-gradient-to-r from-fuchsia-600 to-pink-600',
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      <Controller
        ...
        render={({ field: { onChange } }) => {
          return (
            <label className="cursor-pointer inline-flex items-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-500 focus:outline-none placeholder-gray-300">
